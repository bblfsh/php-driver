pipeline {
  agent {
    kubernetes {
      label 'php-driver-bblfsh-performance'
      defaultContainer 'php-driver-bblfsh-performance'
      yaml """
spec:
  nodeSelector:
  ...
  containers:
  - name: php-driver-bblfsh-performance
...
"""
  ...
  environment {
    DRIVER_LANGUAGE = "php"
    DRIVER_REPO = "https://github.com/bblfsh/php-driver.git"
